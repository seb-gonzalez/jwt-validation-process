...
public class Main {
	...
	public static void main(String[] args) {
		...
		//String jwtToken = "8.eyJpc3MiOiIiLCJhcGlLZXkiOiIiLCJpYXQiOjAsImV4cCI6MCwic3ViIjoiNWI2NzNjZmJiNWY1NGJlNWJhN2IyZmNjZWM4NDU1ZTMifQ.5";
		


		JWTProcessor processor = new JWTProcessor();

		if (processor.isTokenFormatValid(jwtToken) && processor.isValid(jwtToken)) {
